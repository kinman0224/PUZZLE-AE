...
def build_tokenizer(args):
    ...
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        # HACK(lkm): for huggingface tokenizer compatibility
        assert args.tokenizer_model is not None
        if args.rank == 0:
            print(" Loading tokenizer from pre-trained model")
        tokenizer = _get_hf_tokenizer(model_name_or_path=args.tokenizer_model, fast_tokenizer=False)
    else:
...
def _get_hf_tokenizer(model_name_or_path, fast_tokenizer=False):
