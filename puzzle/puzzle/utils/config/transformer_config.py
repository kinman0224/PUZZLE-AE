...
class TransformerConfig(ModelParallelConfig):
    """Configuration object for megatron-core transformers.
        ...
        fp16_lm_cross_entropy: (bool): If true, Move the cross entropy unreduced loss calculation for lm head to fp16.
    ...
    def __post_init__(self):
        ...
        if self.recompute_granularity is not None:
            ...
            elif not self.recompute_granularity in ['selective']:
                raise ValueError(
